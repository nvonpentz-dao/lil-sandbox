...
export { default as LilVRGDAABI } from '../abi/contracts/governance/NounsDAOLogicV1.sol/NounsDAOLogicV1.json';
...
export { LilVrgda__factory as LilVRGDAFactory } from '../typechain/factories/LilVrgda__factory';
